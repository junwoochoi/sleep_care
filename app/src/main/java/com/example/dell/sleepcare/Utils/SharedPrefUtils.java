...
public class SharedPrefUtils {
    //프리퍼런스 KEY값
    public static final String PREFERENCE_NAME= Constants.PREF_USERDATA;
    private static SharedPrefUtils preferencemodule = null;
    ...
    public static SharedPrefUtils getInstance(Context context) {
        ...
        if (preferencemodule == null) {
            preferencemodule = new SharedPrefUtils();
        }
        if(prefs==null){
