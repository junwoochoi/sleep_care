...
public class RegisterDialog extends Dialog implements DatePickerDialog.OnDateSetListener {
    ...
    public RegisterDialog(@NonNull Context context, android.app.FragmentManager fragmentManager, String userName, String userEmail) {
        super(context);
    ...
    private void registerDB(){
        ...
        final Call<LoginResult> res = loginService.register(userName, userEmail, userDate, userJob, userAddr );
